...
const instructions = {
  ...
  pages: [
    `<p>Вам будет показано 30 изображений с двумя объектами.</p>
     <p>Нажимайте <strong>"Одинаковые"</strong>, если на картинке — два одинаковых объекта, но, возможно, по разному повёрнутые,  
     или <strong>"Разные"</strong>, если объекты разные.</p>
